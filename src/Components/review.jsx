    ...
    <div>
      <div className="row d-flex flex-row custom-card1 mt-5 mx-5 justify-content-around py-2">
        <div className="col-md-6 p-4">
          <h2 id="heading">What people are saying about us</h2>
        </div>
        <div className="col-md-5 p-4 py-4">
          <p id="sub-text" className="mont">
            Has everything you need to keep track of your sales and grow your
      ...
      <div className="row d-flex flex-wrap justify-content-around mt-5">
        <div className="col-md-3 m-4 custom-card" id="card1">
          ...
          <p>
            ...
            explicabo error repudiandae illum animi cum odio eum, nemo ipsam
            aperiam?
          </p>
